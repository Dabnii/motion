...
import { MediaSectionInput } from "./components/dialog/input/media_input.js";
...
new App(document.querySelector(".document")! as HTMLElement, document.body); //document.body 안으로 전달
